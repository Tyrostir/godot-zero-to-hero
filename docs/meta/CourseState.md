...
| **Chapters published** | **28 / 359** — 🎉 **Module 0 complete** (19) · 🎉 **block 1A complete** (7) · block 1B in progress (2/4). Index: [docs/chapters/README.md](../chapters/README.md) |
...
| 🤖 **Me — next turn** | **Chapter 1.9 — Rotations, gimbal lock and quaternions.** |
...
[x] 1.6 · [x] 1.7 · [x] 1.8 · [ ] 1.9 · [ ] 1.10 (X) · [ ] 1.11
