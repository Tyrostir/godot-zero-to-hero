...
| **Chapters published** | **36 / 359** — 🎉 **Module 0 complete** (19) · 🎉 **block 1A complete** (7) · 🎉 **block 1B complete** (4) · 🎉 **block 1C complete** (6). Index: [docs/chapters/README.md](../chapters/README.md) |
...
| 🤖 **Me — next turn** | **Block 1D — Input, on a phone**, starting with 1.16 (the InputMap). |
...
**This tracker mirrors what is *published*.** Your own reading position is yours to keep; the ticks here say what exists to read.

`[ ]` not started · `[~]` in progress · `[x]` done · `[!]` done but shaky (revisit) · `[-]` skipped deliberately
...
[x] 1.6 · [x] 1.7 · [x] 1.8 · [x] 1.9 · [x] 1.10 (X) · [x] 1.11
[x] 1.11b 🧰 · [x] 1.12 · [x] 1.13 · [x] 1.13b 🧰 · [x] 1.14 · [ ] 1.15
