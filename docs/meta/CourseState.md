...
| **Chapters published** | **35 / 359** — 🎉 **Module 0 complete** (19) · 🎉 **block 1A complete** (7) · 🎉 **block 1B complete** (4) · block 1C in progress (5/6). Index: [docs/chapters/README.md](../chapters/README.md) |
...
| 🤖 **Me — next turn** | **Chapter 1.14 — Area3D triggers**, closing block 1C. |
...
[x] 1.11b 🧰 · [x] 1.12 · [x] 1.13 · [x] 1.13b 🧰 · [ ] 1.14 · [ ] 1.15
