...
| **Chapters published** | **32 / 359** — 🎉 **Module 0 complete** (19) · 🎉 **block 1A complete** (7) · 🎉 **block 1B complete** (4) · block 1C in progress (2/6). Index: [docs/chapters/README.md](../chapters/README.md) |
...
| 🤖 **Me — next turn** | **Chapter 1.12 — collision shapes, layers and masks.** |
...
[x] 1.11b 🧰 · [ ] 1.12 · [ ] 1.13 · [ ] 1.13b 🧰 · [ ] 1.14 · [ ] 1.15
