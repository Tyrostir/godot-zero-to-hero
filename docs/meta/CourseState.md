...
| **Chapters published** | **31 / 359** — 🎉 **Module 0 complete** (19) · 🎉 **block 1A complete** (7) · 🎉 **block 1B complete** (4) · block 1C in progress (1/6). Index: [docs/chapters/README.md](../chapters/README.md) |
...
| 🤖 **Me — next turn** | **Chapter 1.11b — Debug Draw 3D and Panku Console** 🧰. |
