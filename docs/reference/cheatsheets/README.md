...
update_trigger: "When a cheat sheet is written, alongside the chapter that introduces its material"
---

# 📎 docs/reference/cheatsheets/

One page each. Written **alongside the chapter that introduces the material**, not in advance — a cheat sheet for something you haven't used is just a list.
