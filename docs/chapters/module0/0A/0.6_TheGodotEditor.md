...
- **Prerequisite:** the `Scratch` project from [0.2](0.2_GodotAndDotNet.md), containing `testcube.glb` from [0.3](0.3_Blender.md). If you skipped 0.3, add any `MeshInstance3D` with a `BoxMesh` instead.
...
| You need | From |
|---|---|
| The `Scratch` project | [0.2](0.2_GodotAndDotNet.md) |
| `testcube.glb` in it | [0.3](0.3_Blender.md) — or substitute a `BoxMesh` |
| C# building successfully | [0.2](0.2_GodotAndDotNet.md) Step 7 |
...
**[0.7 — Git for game projects: the Godot `.gitignore`, Git LFS, first commit](0.7_GitForGameProjects.md).** You have made files worth keeping. Next you learn which of them belong in version control — and prove it, rather than trusting a `.gitignore` someone handed you.
