...
| You need | From |
|---|---|
| [Chapter 0.1](0.1_MachinesAndTheirRoles.md) done | You know your specs, and `vulkaninfo` sees your GPU |
...
**[0.3 — Installing Blender, and configuring it once so you never fight it again](0.3_Blender.md).** You have the code half of the workshop. Next, the art half — and a round-trip test that proves the two agree about how big a metre is.
