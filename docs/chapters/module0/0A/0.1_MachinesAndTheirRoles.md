...
| Nothing installed | Not Godot, not Blender, not the Android SDK. That is [0.2](0.2_GodotAndDotNet.md) onwards |
...
If Vulkan reports **zero devices**, your graphics driver needs attention before [0.2](0.2_GodotAndDotNet.md) — note it now rather than discovering it while trying to open Godot.
...
Fill in **every** field in the *Workshop*, *Target* and *Ratios* sections from Steps 1–4. Leave the tool-version table alone for now; [0.2](0.2_GodotAndDotNet.md)–[0.4](0.4_AndroidToolchain.md) fill that.
...
1. [`docs/guides/Setup_01_Prerequisites.md`](../../../guides/Setup_01_Prerequisites.md) — fill in the **test device** table in §3. Leave the tool-version rows blank; those come in [0.2](0.2_GodotAndDotNet.md)–[0.4](0.4_AndroidToolchain.md).
