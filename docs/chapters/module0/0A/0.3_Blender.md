...
| You need | Why |
|---|---|
| [0.2](0.2_GodotAndDotNet.md) done | The round trip needs a Godot project to import into |
...
1. Open your `Scratch` Godot project from [0.2](0.2_GodotAndDotNet.md).
...
This is the definitive answer, and it reuses [0.2](0.2_GodotAndDotNet.md).
...
**[0.4 — JDK, Android SDK, platform tools, and the debug keystore](0.4_AndroidToolchain.md).** Code half done, art half done. Next is the part that turns them into something your phone will install — and the part with the most fiddly failure modes in the whole course.
